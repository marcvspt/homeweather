        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">URL para ver los datos por medio de API</h5>
                  <pre><code>http://localhost/api/ver.php?api_token=<?php echo $_SESSION['api_token']; ?></code></pre>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">URL para cargar los datos por medio de API</h5>
                  <pre><code>http://localhost/api/carga.php?sensor1=$DATA&sensor2=$DATA&sensor3=$DATA&sensor4=$DATA&sensor5=$DATA&api_token=<?php echo $_SESSION['api_token']; ?></code></pre>
                </div>
              </div>
            </div>
          </div>
