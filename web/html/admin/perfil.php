    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class='row'>
            <div class='col-lg-12'>
              <form id="perfil" name="perfil" action="" method="post" enctype="multipart/form-data">
                <div class="form-group col-md-12">
                  <h2 class="pull-left"><b>Datos del perfil</b></h2>
                </div>
                <div id="datos">
                  <br>
                </div>
                <div class='form-row'>
                  ...
                  <div class='form-group col-md-6'>
                    <br>
                    <button type="submit" class='btn-info btn-block'>Actualizar</button>
                  </div>
                  <div class='form-group col-md-6'>
                    <br>
                    <a class='btn btn-warning btn-block' href='index.php'>Regresar</a>
                  </div>
                </div>
              </form>
            </div>
