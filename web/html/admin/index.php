    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper" align="center">
          ...
          <img src="../assets/images/bienvenido.png"><br><br>
          <div class='row'>
            <div class="form-group col-md-4">
              <h4><b>¿En dónde estoy?</b></h4>
              <p>Este es un panel de monitoreo, aquí podras revisar los datos sensados y gráficos <a href="chars.php">aquí</a>, así como ver y modificar tus datos personales.</p>
              <img src="../assets/images/check.png" width="50%">
            </div>
            <div class="form-group col-md-4">
              <h4><b>¿Cómo puedo usar el servicio?</b></h4>
              <p>Al registrarte se te asignará un token (ver <a href="api.php">aqui</a>), está clave es necesaria para usar la API que controla la carga y visualización de datos.</p>
              <img src="../assets/images/info.png" width="50%">
            </div>
            <div class="form-group col-md-4">
              <h4><b>¿Qué hago si el servicio no funciona?</b></h4>
              <p>Visita nuestras redes sociales para estar al día con los mantenimientos. Si este no es tu caso, contactanos a <span><a href="mailto:soporte.homeweather@gmail.com">soporte.homeweather@gmail.com</a></span>.</p>
              <img src="../assets/images/cross.png" width="50%">
            </div>
          </div>
          <!--AQUI VA EL CONTENIDO-->
        </div>
