              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-5">
                    ...
                    <input class="form-control" type="text" name="caja_busqueda" id="caja_busqueda" placeholder="2000-01-01 00:00:01"></input>
                  </div>
                  <div class="col-md-7">
                    <label>API TOKEN</label>
                    <a href="configuracion.php" class="btn btn-info " name="token" id="token"><?php echo $_SESSION['api_token'] ?></a>
                    <br><br>
                  </div>
                </div>
                <div id="datos">
